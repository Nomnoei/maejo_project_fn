      ...
      <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="form-group row">
                ...
                <div class="col-md-7">
                  <textarea name="house" rows="8" cols="80" class="form-control" v-model="address"></textarea>
                </div>
            </div>
...
<script>
    ...
    export default {
      ...
      methods:{
          ...
          axios.post(this.$store.getters.url+"api/ThisOfficer",formData2,headers).then(response => {
            // console.log(response.data.address[0].house);
            this.address = response.data.address[0].house;
          });
        ...
        EditProfile(){
          this.$confirm(
            ...
            .then(() => {
              ...
              axios.post(this.$store.getters.url+"api/UpdateOfficerAddress",formData2,headers).then(response => {
